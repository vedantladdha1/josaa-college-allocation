...
import { dummyStudents, Student } from "@/lib/dummyStudentData"
...
export default function AllotmentResult() {
  ...
  const [searchCategory, setSearchCategory] = useState<"name" | "college" | "state" | "category">("name")
  ...
  useEffect(() => {
    ...
    setAllotmentResults(results.filter((r) => r.round === selectedRound))
